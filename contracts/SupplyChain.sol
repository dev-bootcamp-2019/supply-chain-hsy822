...
contract SupplyChain {
  ...
  */
  ...
  /* Create a modifer that checks if the msg.sender is the owner of the contract */
    ...
    modifier forSale (uint _sku) { require(uint(State.ForSale) == items[_sku].state); _; }
    modifier sold (uint _sku) { require(uint(State.Sold) == items[_sku].state); _; }
    modifier shipped (uint _sku) { require(uint(State.Shipped) == items[_sku].state); _; }
    modifier received (uint _sku) { require(uint(State.Received) == items[_sku].state); _; }
